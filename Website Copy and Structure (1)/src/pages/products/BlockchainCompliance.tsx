    ...
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-br from-green-600 to-emerald-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="inline-block bg-green-500 bg-opacity-30 px-4 py-2 rounded-full mb-6">
              <span className="text-sm">Blockchain Smart Contracts & Traceability</span>
            </div>
            <h1 className="text-white mb-6">Trace Every Step, Meet Every Standard</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link 
                to="/contact" 
                className="inline-flex items-center justify-center bg-white text-green-600 px-6 py-3 rounded-lg hover:bg-green-50 transition"
              >
                Request Demo
              ...
              <Link 
                to="/use-cases" 
                className="inline-flex items-center justify-center border border-white text-white px-6 py-3 rounded-lg hover:bg-white hover:text-green-600 transition"
              >
                See It In Action
              </Link>
            </div>
              ...
              <div className="bg-green-50 border-l-4 border-green-600 p-6 rounded mb-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span><span className="text-green-700">Environmental:</span> Carbon emissions, water usage, waste reduction, renewable energy</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-green-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span><span className="text-green-700">Social:</span> Fair wages, working conditions, community impact, gender diversity</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-green-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span><span className="text-green-700">Governance:</span> Ethical sourcing, transparency, certifications, audit trails</span>
                  </li>
                </ul>
              </div>
              <Link to="/contact" className="inline-flex items-center text-green-600 hover:text-green-700">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <Link to="/use-cases" className="text-green-600 hover:text-green-700 inline-flex items-center text-sm">
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-white mb-4">Ready for Export Compliance?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/contact" 
              className="inline-flex items-center justify-center bg-white text-green-600 px-8 py-3 rounded-lg hover:bg-green-50 transition"
            >
            ...
            <Link 
              to="/resources" 
              className="inline-flex items-center justify-center border border-white text-white px-8 py-3 rounded-lg hover:bg-white hover:text-green-600 transition"
            >
              Download EUDR Guide
            </Link>
          </div>
