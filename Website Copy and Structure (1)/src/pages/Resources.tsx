    ...
    <div className="bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0F172A] via-[#6C2BD9] to-[#A855F7] text-white py-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <span className="tagline text-[#06B6D4] mb-4 block">RESOURCES & INSIGHTS</span>
            <h1 className="text-5xl md:text-6xl font-black text-white mb-6 leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>Resources & Insights</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg hover:shadow-md transition">
              ...
              <button className="text-[#6C2BD9] hover:text-blue-700 inline-flex items-center">
            ...
            <div className="bg-gray-50 p-6 rounded-lg hover:shadow-md transition">
              ...
              <button className="text-[#06B6D4] hover:text-green-700 inline-flex items-center">
                <Download className="w-4 h-4 mr-1" />
                Download PDF
              </button>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg hover:shadow-md transition">
              <div className="bg-gradient-to-br from-[#A855F7] to-[#C084FC] w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                <FileText className="w-6 h-6 text-white" />
              </div>
              ...
              <button className="text-[#A855F7] hover:text-purple-700 inline-flex items-center">
                <Download className="w-4 h-4 mr-1" />
                Download PDF
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <Link to="#" className="text-[#6C2BD9] hover:text-blue-700 inline-flex items-center text-sm">
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 p-6 rounded-lg flex items-center justify-between">
              <div className="flex items-start">
                <FileText className="w-8 h-8 text-[#6C2BD9] mr-4 flex-shrink-0 mt-1" />
                <div>
              ...
              <button className="text-[#6C2BD9] hover:text-blue-700 inline-flex items-center flex-shrink-0 ml-4">
                <Download className="w-4 h-4 mr-1" />
                Download
              </button>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg flex items-center justify-between">
              <div className="flex items-start">
                <FileText className="w-8 h-8 text-[#06B6D4] mr-4 flex-shrink-0 mt-1" />
                <div>
              ...
              <button className="text-[#06B6D4] hover:text-green-700 inline-flex items-center flex-shrink-0 ml-4">
                <Download className="w-4 h-4 mr-1" />
                Download
              </button>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg flex items-center justify-between">
              <div className="flex items-start">
                <FileText className="w-8 h-8 text-[#A855F7] mr-4 flex-shrink-0 mt-1" />
                <div>
              ...
              <button className="text-[#A855F7] hover:text-purple-700 inline-flex items-center flex-shrink-0 ml-4">
                <Download className="w-4 h-4 mr-1" />
                Download
              </button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                ...
                <button className="text-[#6C2BD9] hover:text-blue-700 text-sm">Watch Now</button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                ...
                <button className="text-[#06B6D4] hover:text-green-700 text-sm">Watch Now</button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                ...
                <button className="text-[#A855F7] hover:text-purple-700 text-sm">Watch Now</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#0F172A] via-[#6C2BD9] to-[#A855F7] text-white">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-white mb-4" style={{ fontFamily: 'var(--font-heading)' }}>Want to Contribute to Our Blog?</h2>
